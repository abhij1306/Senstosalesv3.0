...
class ExcelService:
    ...
    def generate_technical_summary(items: list[dict], db: sqlite3.Connection, save_path: str = None) -> StreamingResponse:
        ...
        fmt_footer = workbook.add_format({
            "bold": True, "font_name": font_name, "align": "right"
        })
    ...
    def generate_po_upload_template() -> StreamingResponse:
        ...
        headers = [
            "PO Number", "PO Date", "Vendor Name", "Project Name", "Item No",
            "Material Code", "Description", "Unit", "Qty", "Rate", "Delivery Date"
        ]
    ...
    def generate_srv_upload_template() -> StreamingResponse:
        ...
        headers = [
            ...
            "Received Qty", "Rejected Qty", "Challan No", "Challan Date",
            "Invoice No", "Invoice Date", "Remarks"
        ]
    ...
    def generate_exact_dc_excel(header: dict, items: list[dict], db: sqlite3.Connection, save_path: str = None):
        ...
        fmt_th = workbook.add_format({
            "bold": True, "border": 1, "align": "center", "valign": "vcenter", 
            "font_name": base_font, "text_wrap": True, "font_size": 11
        })
    ...
    def generate_gc_excel(header: dict, items: list[dict], db: sqlite3.Connection, save_path: str = None) -> StreamingResponse:
        ...
        fmt_table_header = workbook.add_format({
            "bold": True, "border": 1, "align": "center", "valign": "vcenter", 
            "font_name": font_name, "font_size": 11, "text_wrap": True
        })
        ...
        fmt_footer_text = workbook.add_format({
            ...
            "align": "left", "font_name": font_name, "font_size": 11
        })
        ...
        for idx, item in enumerate(items):
            ...
            if str(unit).upper() == "NO": unit = "NOS" # Normalize
        ...
        fmt_gst_line = workbook.add_format({
            "border": 1, "align": "left", "valign": "vcenter", 
            "font_name": font_name, "font_size": 11, "indent": 1
        })
